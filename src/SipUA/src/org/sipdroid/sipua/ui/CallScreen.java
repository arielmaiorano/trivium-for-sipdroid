...
public class CallScreen extends Activity implements DialogInterface.OnClickListener {
	...
	// xxx
	public static final int ENCRYPTION_MENU_ITEM = FIRST_MENU_ID + 11;
	public static final String ENCRYPTION_MENU_ITEM_STR_ON = "Activar cifrado";
	public static final String ENCRYPTION_MENU_ITEM_STR_OFF = "Desactivar cifrado";
	public static boolean encryptionOn = false;
	public static String encryptionPassword = null;
	public MenuItem menuItemEncryption = null;
	public static CallScreen _instance = null;
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		// xxx
		m = menu.add(0, ENCRYPTION_MENU_ITEM, 0, ENCRYPTION_MENU_ITEM_STR_ON);
		m.setIcon(android.R.drawable.ic_menu_call);
		menuItemEncryption = m;
		_instance = this;
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		// xxx
		case ENCRYPTION_MENU_ITEM:
			if (encryptionOn)	{
				menuItemEncryption.setTitle(ENCRYPTION_MENU_ITEM_STR_ON);
				encryptionOn = false;
			} else	{
				//menuItemEncryption.setTitle(ENCRYPTION_MENU_ITEM_STR_OFF);
				//encryptionOn = true;
				
				AlertDialog.Builder builder = new AlertDialog.Builder(this);
				builder.setTitle("Ingreso de clave");
